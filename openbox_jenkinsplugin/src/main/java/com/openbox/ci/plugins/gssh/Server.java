package com.openbox.ci.plugins.gssh;
...
public class Server {
	...
	public static void main(String...args){
		String serverinfo ="tahoe~~tas~~10.224.58.190";
		System.out.println("server ip:"+Server.parseIp(serverinfo));
		System.out.println("group name:"+Server.parseServerGroupName(serverinfo));
	}
}
